...
func (c *messageServiceClient) GetConversations(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetConversationsResponse, error) {
	out := new(GetConversationsResponse)
	err := c.cc.Invoke(ctx, "/MessageService/GetConversations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMessageServiceServer) GetConversations(context.Context, *emptypb.Empty) (*GetConversationsResponse, error) {
...
func _MessageService_GetConversations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/MessageService/GetConversations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageServiceServer).GetConversations(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
