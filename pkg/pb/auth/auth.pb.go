...
var file_auth_auth_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3f, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x71,
	...
	0x74, 0x65, 0x64, 0x41, 0x74, 0x32, 0xa9, 0x02, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65,
...
var file_auth_auth_proto_goTypes = []interface{}{
	...
	(*FindUsersRequest)(nil),  // 3: auth.FindUsersRequest
	(*FindUsersResponse)(nil), // 4: auth.FindUsersResponse
	(*User)(nil),              // 5: auth.User
}
var file_auth_auth_proto_depIdxs = []int32{
	5, // 0: auth.FindUsersResponse.users:type_name -> auth.User
	...
	3, // 4: auth.AuthService.FindUser:input_type -> auth.FindUsersRequest
	1, // 5: auth.AuthService.Register:output_type -> auth.AuthResponse
	1, // 6: auth.AuthService.Auth:output_type -> auth.AuthResponse
	5, // 7: auth.AuthService.GetUser:output_type -> auth.User
	4, // 8: auth.AuthService.FindUser:output_type -> auth.FindUsersResponse
